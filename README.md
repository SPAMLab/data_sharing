...
3 - Code for Paper - Garcia, G.P.B., Soares, L.P., Espadoto, M., Grohmann, C.H., 2023 - Relict landslide detection using deep-learning architectures for image segmentation in rainforest areas: a new framework ([Link to repo](https://github.com/SPAMLab/data_sharing/tree/main/Relict_landslides_CNN_kmeans))  
Preprint available in ArXiv. DOI: https://doi.org/10.48550/arXiv.2208.02693  
Final paper published in the International Journal of Remote Sensing (paywalled): https://doi.org/10.1080/01431161.2023.2197130  
